              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-400">915.0 MHz · LoRa Point-to-Point</p>
                  </div>
                </div>
        ...
        <div className="lg:col-span-5 flex flex-col" id="technical-details">
          <Card className="p-4 flex-1 flex flex-col justify-between divide-y divide-gray-100 shadow-sm">
            ...
            <div className="pb-2.5 flex items-center justify-between">
              ...
              <span className="text-[10px] font-medium text-green-700 bg-green-50 px-2 py-0.5 rounded-full border border-green-200/60 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                Live Telemetry
              </span>
            </div>
